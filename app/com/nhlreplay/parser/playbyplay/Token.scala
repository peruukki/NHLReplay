...
object Token {
  ...
  val DrawnBy = Token("", Pattern.DrawnBy, TokenVisibility.Ignored)
  ...
  val ServedBy = Token("", Pattern.ServedBy, TokenVisibility.Ignored)
  val ServedByPlayer = Token(GameEvent.ServedByPlayer, Pattern.Player, TokenVisibility.Internal, Trimmer.trimWhitespace)
